  ...
  await sendMail({
    ...
    html: `
      <div style="font-family:-apple-system,Segoe UI,Roboto,sans-serif;max-width:420px;margin:0 auto;padding:24px">
        ...
        <p style="color:#555;margin:0 0 20px">Enter this code to sign in to MedSchoolPrep. It expires in 10 minutes.</p>
    ...
    `,
    text: `Your MedSchoolPrep verification code is ${code}. It expires in 10 minutes.`,
  });
}
