...
export const VALUE_THEMES = [
  ...
  { id: 'craft', label: 'Craft and material', words: 'craft make build design draw paint sculpt sketch fabricate prototype iterate material texture hand tool studio scrap paper canvas colour color assemble compose', frame: 'You think through your hands, and what you make is how you find out what you think.' },
  ...
  { id: 'community', label: 'Belonging and community', words: 'community belong together neighbor neighbour neighborhood gather host welcome tradition heritage festival club member team collective shared local town neighborhood congregation', frame: 'You build the room where people can be in the same place.' },
