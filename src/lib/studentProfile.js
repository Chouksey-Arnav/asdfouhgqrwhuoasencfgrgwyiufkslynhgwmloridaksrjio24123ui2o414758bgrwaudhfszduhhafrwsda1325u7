...
// data) into (a) a rich, prioritized Metabrain system prompt and (b) an
...
// computed once for routing and then thrown away, so Metabrain (and the rest
...
The student is on the ${pathwayLabel} pathway. ${pathCoachNote}`;
