...
export const MATH_GEO_TRIG_QUESTIONS = [
  ...
  // ── Circles ───────────────────────────────────────────────────────────────
  {
    ...
    q: 'A circle in the xy-plane has the equation (x − 3)² + (y + 2)² = 25. What are the coordinates of its center and the length of its radius?',
    ch: [
      'Center (3, −2), radius 5',
      'Center (−3, 2), radius 5',
    ...
    ans: 0,
    exp: 'In (x − h)² + (y − k)² = r², the center is (h, k) and the radius is r. Here x − 3 gives h = 3, and y + 2 is y − (−2) so k = −2. The right side is r² = 25, so r = 5.',
    distractorExp: [
