...
export const MATH_GEO_TRIG_C = [
  ...
  },
  {
    ...
    q: 'In the xy-plane, the graph of (x − 3)² + (y + 2)² = 25 is a circle. What are the centre and radius of the circle?',
    ch: [
      'Centre (3, −2), radius 5',
      'Centre (−3, 2), radius 5',
    ...
    ans: 0,
    exp: 'In the form (x − h)² + (y − k)² = r², the centre is (h, k) and the radius is r. Here x − 3 gives h = 3; y + 2 is y − (−2), so k = −2; and r² = 25 gives r = 5.',
    distractorExp: [
