...
export const INTERVIEW_QUESTIONS = {
  general: [
    ...
    "Tell me about a time you had to work alongside someone who disagreed with your approach.",
  ...
  physician: [
    ...
    "Describe a science fair project, research experience, or HOSA activity that shaped your interest.",
    ...
    "Name a part of medicine that isn't glamorous but that you think would suit your temperament.",
  ...
  physicalOccupTherapy: [
    ...
    "This is an exploratory interest for you right now — what would help you confirm this path is right for you?",
    "Tell me about a time you motivated someone who was on the edge of quitting.",
  ...
  publicHealth: [
    ...
    "Tell me about a community-service or volunteering experience — what did you learn about that community?",
  ...
  healthAdmin: [
    ...
    "Tell me about a time you had to deliver a decision that split the group.",
  ...
  exploring: [
    ...
    "Describe a science fair project, research experience, or HOSA/health-club activity that shaped your interest.",
  ...
  scholarship: [
    ...
    "Describe a private moment of genuine pride — one you've never mentioned to anyone in your family.",
  ],
  behavioral: [
