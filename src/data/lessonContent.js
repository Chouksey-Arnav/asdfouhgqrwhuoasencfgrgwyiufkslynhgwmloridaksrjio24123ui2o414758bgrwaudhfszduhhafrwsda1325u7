...
// here — currently the Exploring Pre-Health pathway. Lessons without an entry
// fall back to their `url`/`src`/`objectives` fields in constants.js inside
// the LessonPlayer's Article/Video steps.
//
