...
export const ELIB_EXPANSION_C = [
  ...
  { cat:'Life Sciences', title:'BioDigital Human', url:'https://human.biodigital.com/', type:'App', free:true, difficulty:'AP / Intermediate', desc:'A free interactive 3D human anatomy visualization tool letting you explore body systems layer by layer.' },
  ...
  { cat:'Research Methods', title:'NIGMS Biomedical Beat Blog', url:'https://nigms.nih.gov/biobeat', type:'Article', free:true, difficulty:'AP / Intermediate', desc:"The National Institute of General Medical Sciences' blog explaining real, current biomedical research in accessible terms." },
  ...
  { cat:'Test Prep', title:'Official ACT Test Prep', url:'https://www.act.org/content/act/en/products-and-services/the-act/test-preparation.html', type:'Article', free:true, difficulty:'Introductory', desc:'Free official ACT practice tests, sample questions, and test-day guidance directly from ACT, Inc.' },
