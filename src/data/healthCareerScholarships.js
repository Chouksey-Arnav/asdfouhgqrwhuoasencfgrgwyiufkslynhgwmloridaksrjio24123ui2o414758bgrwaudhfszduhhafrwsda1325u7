...
export const HEALTH_SCHOLARSHIPS = [
  ...
  },
  {
    ...
    kind: 'discovery',
    name: 'Rural and hometown "come back and practise here" funds',
    org: 'Rural hospitals, county health departments and community foundations',
    openTo: ['senior'],
    pathways: ['md', 'pa', 'rn', 'pharmd', 'dds'],
    eligibility: 'Rural counties, critical-access hospitals and community foundations frequently fund a local student entering a health profession, sometimes with an informal or formal expectation that they return to practise.',
    howToFind: 'Ask your school counsellor for the local community foundation\'s scholarship list, and ask the administrator at your nearest rural hospital directly. Also read the state rural service programs in the section above — they are the professional-school version of this same idea.',
  ...
  },
  {
    ...
    eligibility: 'Nursing students (Nurse Corps, including undergraduate BSN students) and health professional students (NHSC). Not open to high school students — but the Nurse Corps opens as early as your first year of a nursing program, which is sooner than most people realise.',
