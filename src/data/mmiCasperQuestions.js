...
//
// Every entry carries a `station` key into STATION_TYPES (src/lib/interviewPanel.js). It does two
// jobs: it casts the station with the right panellist (the dean takes the ethics stations, the
// nurse educator takes the empathy and teamwork ones), and it tells the scorer which AAMC
// competencies this station can actually assess — a station that never probed teamwork does not get
// a teamwork score, because inventing one is how a rubric becomes decoration.
//
// The prompts also all end on a noun rather than a preposition. That is not fussiness: a stem
// ending on a function word takes a rising, uncertain terminal when it is spoken aloud, and an
// interviewer who sounds unsure of their own question is unsettling to listen to. The lint that
// enforces it is questionStemIssue() in src/lib/voicePipeline.js, run over this file by
// scripts/verifyInterviewRealism.mjs.
// ─────────────────────────────────────────────────────────────────────────────

export const MMI_STATIONS = [
  { id:'mmi1', station:'ethical', prompt:'A close friend asks you to cover for them so they can skip a commitment they promised to keep. What do you say to them, and why?' },
  { id:'mmi2', station:'teamwork', prompt:'You\'re working on a group project and one member consistently does less than their share, but is well-liked by the rest of the group. How do you handle it?' },
  { id:'mmi3', station:'ethical', prompt:'You witness someone being treated unfairly by an authority figure (a teacher, coach, or boss) but speaking up could have consequences for you. Walk through how you\'d think about it.' },
  { id:'mmi4', station:'empathy', prompt:'A teammate makes a mistake that affects the whole team\'s result, and they\'re clearly upset about it. What do you say to them?' },
  { id:'mmi5', station:'teamwork', prompt:'You disagree with a decision your group has made, but you\'re outvoted. Do you go along with it, and how do you handle your disagreement?' },
  { id:'mmi6', station:'ethical', prompt:'Someone shares something with you in confidence that you think could put them at risk if they don\'t tell someone else. What do you do?' },
  { id:'mmi7', station:'ethical', prompt:'You\'re given credit for something a teammate actually did most of the work on. How do you handle it?' },
  { id:'mmi8', station:'communication', prompt:'A younger student looks up to you and is about to make a decision you think is a mistake. How do you approach the conversation?' },
  { id:'mmi9', station:'ethical', prompt:'A classmate confides that they cheated on an important test and got the top grade, which bumped you down. They ask you to keep it quiet. What do you do?' },
  { id:'mmi10', station:'ethical', prompt:'You\'re volunteering and a supervisor asks you to do something you think is unfair to the people you\'re serving, but not against any rule. How do you respond?' },
  { id:'mmi11', station:'empathy', prompt:'A new student in your class is being quietly excluded by your friend group. What, if anything, do you do?' },
  { id:'mmi12', station:'teamwork', prompt:'You have limited time and can either help a struggling teammate finish their part or polish your own to make the whole project shine. How do you decide?' },
  { id:'mmi13', station:'communication', prompt:'A family member holds a strong opinion you deeply disagree with. They bring it up at dinner in front of guests. How do you handle the moment?' },
  { id:'mmi14', station:'teamwork', prompt:'You\'re leading a club and two members you both value are in a conflict that\'s splitting the group. How do you approach it?' },
  { id:'mmi15', station:'teamwork', prompt:'You promised two different people you\'d help them at the same time, and you can\'t do both. Walk me through how you handle it.' },
  { id:'mmi16', station:'ethical', prompt:'You realize partway through a competition that a rule is being interpreted in a way that unfairly benefits your team. Do you say anything?' },
  { id:'mmi17', station:'ethical', prompt:'A friend is spreading a rumor you know is false about someone you don\'t particularly like. What do you do?' },
  { id:'mmi18', station:'policy', prompt:'Your coach or teacher asks the group to keep quiet about a decision you think other students have a right to know about. How do you work through the decision?' },
  { id:'mmi19', station:'ethical', prompt:'You find a wallet with cash and an ID in the school hallway when no one is around. Walk me through exactly what you do and why.' },
  { id:'mmi20', station:'ethical', prompt:'A peer asks to copy your homework because they were caring for a sick family member all week and truly had no time. How do you respond?' },
  { id:'mmi21', station:'communication', prompt:'You\'re asked to give honest feedback on a close friend\'s project that you think isn\'t very good, and it matters to them a lot. What do you say?' },
  { id:'mmi22', station:'teamwork', prompt:'Your team wants to celebrate a win in a way that would exclude one member who can\'t participate. How do you handle it?' },
  { id:'mmi23', station:'policy', prompt:'You strongly believe a school policy is wrong. What steps would you actually take, and where would you draw the line?' },
  { id:'mmi24', station:'empathy', prompt:'Someone apologizes to you for something that genuinely hurt you, but you\'re not sure they really mean it. How do you respond?' },
];
...
export const CASPER_SCENARIOS = [
  {
    ...
    probes:[
      ...
      'What factors would you weigh before you say anything to the group?',
